...
func (e *Monitors) Get(monitorID string) (*api.Monitor, error)        { return mockReturn[api.Monitor](e.Called(monitorID)) }
func (e *Monitors) Create(monitor *api.Monitor) (*api.Monitor, error) { return mockReturn[api.Monitor](e.Called(monitor)) }
func (e *Monitors) Update(monitor *api.Monitor) (*api.Monitor, error) { return mockReturn[api.Monitor](e.Called(monitor)) }
